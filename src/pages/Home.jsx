...
const Home = () => {
  ...
  const [theme, setTheme] = useState("material-darker"); // Default theme
        ...
        <div className="h-16 xl:h-20 mb-2 w-[100%] xl:w-[90%] flex items-center justify-between">
          <div>
            <button className="Geist ml-2 text-2xl lg:text-2xl flex items-center text-gray-500 lg:my-2">
              <a
                href="https://www.linkedin.com/in/aditya-surve-b020a525b"
                target="_blank"
                title="This application is created by Aditya Surve"
              >
                <div  className="h-8" alt="LinkedIn Logo" >
                  <GrCommand className="font-bold "/> 
                </div>
              </a>
            </button>
          </div>
